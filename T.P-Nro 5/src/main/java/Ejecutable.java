...
public class Ejecutable {
    ...
    public static Persona CrearAlumno() {
        ...
        return new Alumno(curso, nombre, edad, dni, dir);
    }
    ...
    public static Persona CrearProfesor() {
        ...
        return new Profesor(area, asignaturas, nombre, edad, dni, dir);
    }

    public static void ImprimirTodos(ArrayList<Persona> personas) {
        for (Persona persona : personas) {
            persona.mostrarSusDatos();
        }
    }
